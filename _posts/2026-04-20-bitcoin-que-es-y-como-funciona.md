...
image: /assets/images/bitcoin-que-es-y-como-funciona.webp
redirect_from:
  - /tecnolog%C3%ADa/finanzas/2026/04/20/bitcoin-que-es-y-como-funciona.html
---
...
1. Dices: "quiero enviar X bitcoins a esta dirección"
2. Firmas esa orden con tu llave secreta para demostrar que eres tú
3. Miles de ordenadores en la red verifican que tienes ese dinero y que la firma es válida
4. La transacción se anota en la lista compartida de todo el mundo
